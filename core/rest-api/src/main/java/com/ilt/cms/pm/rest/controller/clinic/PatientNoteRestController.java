...
public class PatientNoteRestController {
    ...
    private PatientNoteApiService patientNoteApiService;

    public PatientNoteRestController(PatientNoteApiService patientNoteApiService) {
        this.patientNoteApiService = patientNoteApiService;
    }
...
//        logger.info("Listing patient notes by[" + name + "] patientId[" + patientId + "]");
        ...
        ResponseEntity<ApiResponse> serviceResponse = patientNoteApiService.patientNote(patientId);
...
//        logger.info("adding a new note by[" + name + "] patientId[" + patientId + "] patientNoteDetails[" + patientNoteDetails + "]");
        ...
        ResponseEntity<ApiResponse> serviceResponse = patientNoteApiService.addNewNote(patientId, patientNoteDetails);
        return serviceResponse;
    }
...
//                + patientNoteDetailId + "] status[" + status + "]");
        ...
        ResponseEntity<ApiResponse> serviceResponse = patientNoteApiService.changeNoteDetailState(patientId, patientNoteDetailId, status);
        return serviceResponse;
    }
}
